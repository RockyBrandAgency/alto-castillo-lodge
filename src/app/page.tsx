...
/**
 * Página de verificación de la Sesión W0 — NO es la Home sensorial final
 * (esa es el checkpoint de motion de la Sesión W1). Prueba que tokens +
 * componentes portados + fotos reales procesadas + Lenis/GSAP funcionan
 * juntos, ya desplegados.
 */
    ...
    <main>
      <section className={styles.hero}>
        ...
        <div className={styles.heroContent}>
          <span className={styles.eyebrow}>Sesión W0 · Página de verificación</span>
      ...
      <div className={styles.wrap}>
        ...
        <section className={styles.section} style={{ borderBottom: "none" }}>
          ...
          <div className={styles.checklist}>
            ...
            <span>
              <strong>—</strong> Home sensorial completa: Sesión W1 (checkpoint de motion aparte)
            </span>
          </div>
        </section>
      </div>
